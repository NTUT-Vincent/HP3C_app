...
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0001','115台北市南港區研究院路一段99號', 'M', '00000001', 1, 'Kevin');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0002', '115台北市南港區研究院路一段99號', 'M', '00000002', 1, 'James');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0003', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000003', 1, 'Bryant');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0004', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000004', 1, 'Kyle');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0005', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'F', '00000005', 1, 'Annie');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0006', '12, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000006', 1,'Annie');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0007', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000007', 1, 'Lue');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0008', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000008', 1, 'Len');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0009', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000009', 1, 'Bob');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0010', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000010', 1, 'Harden');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0011', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000011', 1, 'Tom');
INSERT INTO USER(user_id, address, gender, password, user_type, name) VALUES('customer0012', '1, Sec. 3, Zhongxiao E. Rd., Taipei 10608 Taiwan', 'M', '00000012', 1, 'George');
...
-- insert product 
-- CPU
INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('Intel Core i7-10700', 'Intel', 20, 10390, 10, 'https://e.ecimg.tw/items/DRAI2NA900ANZQ3/000001_1590980027.jpg', true);
INSERT INTO CPU(product_ptr_id, socket, cores, clock, cache) VALUES('Intel Core i7-10700', '1200', 8, '2.90-4.80 GHz', '16MB');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('Intel Core i5-10500', 'Intel', 20, 6750, 10, 'https://d.ecimg.tw/items/DRAI2NA900ANZPG/000001_1590979514.jpg', true);
INSERT INTO CPU(product_ptr_id, socket, cores, clock, cache) VALUES('Intel Core i5-10500', '1200', 6, '3.10-4.50 GHz', '12MB');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('Intel Core i3-10100', 'Intel', 20, 6750, 10, 'https://d.ecimg.tw/items/DRAI2NA900ANZPG/000001_1590979514.jpg', true);
INSERT INTO CPU(product_ptr_id, socket, cores, clock, cache) VALUES('Intel Core i3-10100', '1200', 4, '3.60-4.30 GHz', '6MB');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('AMD Ryzen 7-3800X', 'AMD', 20, 12700, 10, 'https://e.ecimg.tw/items/DRAI07A900A4PG1/000001_1562325857.jpg', true);
INSERT INTO CPU(product_ptr_id, socket, cores, clock, cache) VALUES('AMD Ryzen 7-3800X', 'AM4', 8, '3.90-4.50 GHz', '32MB');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('AMD Ryzen 5-3400G', 'AMD', 20, 4870, 10, 'https://e.ecimg.tw/items/DRAI05A900A4PFX/000001_1562325659.jpg', true);
INSERT INTO CPU(product_ptr_id, socket, cores, clock, cache) VALUES('AMD Ryzen 5-3400G', 'AM4', 4, '3.70-4.20 GHz', '16MB');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('AMD Ryzen 3-3100', 'AMD', 20, 3270, 10, 'https://f.ecimg.tw/items/DRAI2SA900ANOEN/000001_1590033460.jpg', true);
INSERT INTO CPU(product_ptr_id, socket, cores, clock, cache) VALUES('AMD Ryzen 3-3100', 'AM4', 4, '3.60-3.90 GHz', '16MB');

-- GPU
INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('GIGABYTE GeForce RTX 3060 Ti', 'GIGABYTE', 20, 13790, 11, 'https://b.ecimg.tw/items/DRAD1KA900B0TR8/000001_1606844781.jpg', true);
INSERT INTO GPU(product_ptr_id, model, size) VALUES('GIGABYTE GeForce RTX 3060 Ti', 'GeForce RTX 3060 Ti', '8G');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('msi GeForce GTX1660', 'msi', 20, 6090, 11, 'https://d.ecimg.tw/items/DRAD1RA9009V3U6/000001_1599789881.jpg', true);
INSERT INTO GPU(product_ptr_id, model, size) VALUES('msi GeForce GTX1660', 'GeForce GTX 1660', '6G');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('GIGABYTE Radeon RX 6800 GAMING OC 16G', 'GIGYBYTE', 20, 20590, 11, 'https://f.ecimg.tw/items/DRAD1KA900B10T3/000001_1607011477.jpg', true);
INSERT INTO GPU(product_ptr_id, model, size) VALUES('GIGABYTE Radeon RX 6800 GAMING OC 16G', 'Radeon RX 6800','16G');

-- mother board
INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('msi MPG Z490 GAMING EDGE WIFI', 'msi', 20, 7090, 12, 'https://f.ecimg.tw/items/DSAJ28A900ANDGR/000001_1589165310.jpg', true);
INSERT INTO MB(product_ptr_id, chip, size, expansion) VALUES('msi MPG Z490 GAMING EDGE WIFI', '1200', 2, 'unknown');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('ASUS PROART Z490 CREATOR 10G', 'ASUS', 20, 9090, 12, 'https://e.ecimg.tw/items/DSAJ3EA900ANKPQ/000001_1590399233.jpg', true);
INSERT INTO MB(product_ptr_id, chip, size, expansion) VALUES('ASUS PROART Z490 CREATOR 10G', '1200', 2, 'unknown');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('GIGABYTE Z490 AORUS MASTER', 'GIGABYTE', 20, 12090, 12, 'https://b.ecimg.tw/items/DSAJ3KA900AO01W/000001_1590558965.jpg', true);
INSERT INTO MB(product_ptr_id, chip, size, expansion) VALUES('GIGABYTE Z490 AORUS MASTER', '1200', 2, 'unknown');

-- RAM
INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('Kingston DDR4 2666 8GB', 'Kingston', 20, 989, 13, 'https://e.ecimg.tw/items/DRAL3TA900A5PM8/000001_1581502612.jpg', true);
INSERT INTO RAM(product_ptr_id, gen, size, speed, channel) VALUES('Kingston DDR4 2666 8GB', 'DDR4', '8GB', '2666MHz', 0);

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('HyperX Impact DDR4 3200 8GB', 'HyperX', 20, 1183, 13, 'https://e.ecimg.tw/items/DRAL1WA9008WIJC/000001_1533522880.jpg', true);
INSERT INTO RAM(product_ptr_id, gen, size, speed, channel) VALUES('HyperX Impact DDR4 3200 8GB', 'DDR4', '8GB', '3200MHz', 0);

-- ssd
INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('Micron Crucial MX500 1TB SATA3', 'Micron', 20, 2999, 14, 'https://e.ecimg.tw/items/DRAH7GA900AHXTO/000001_1607073876.jpg', true);
INSERT INTO SSD(product_ptr_id, interface, size, speed) VALUES('Micron Crucial MX500 1TB SATA3', 0, '1TB', '560MB/s');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('Kingston KC600 SATA-3 512GB SSD', 'Kingston', 20, 2999, 14, 'https://e.ecimg.tw/items/DRAH7GA900AHXTO/000001_1607073876.jpg', true);
INSERT INTO SSD(product_ptr_id, interface, size, speed) VALUES('Kingston KC600 SATA-3 512GB SSD', 0, '512GB', '550MB/s');

INSERT INTO PRODUCT(type_id, brand, quantity, price, polymorphic_ctype_id, product_picture, available) VALUES('Transcend PCIe SSD 220S 512GB', 'Transcend', 20, 1900, 14, 'http://www.transcend-info.com/products/images/item/TS512GMTE220S-.png', true);
...
INSERT INTO LINE_ITEM VALUES(10, 5, 3, 'Intel Core i7-10700');
